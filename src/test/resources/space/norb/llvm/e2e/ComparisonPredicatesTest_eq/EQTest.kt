...
/**
 * Extracted test case for EQ comparison predicate.
 * Originally from ComparisonPredicatesTest.testEQPredicate()
 */
object EQTest {
    ...
    fun buildIR(module: Module, builder: IRBuilder) {
        ...
        val result = builder.insertICmp(IcmpPredicate.EQ, arg0, arg1, "result")
