...
/**
 * Extracted test case for ptrtoint operation.
 * Demonstrates converting a pointer argument to a 64-bit integer.
 */
object PtrToIntTest {
    ...
    fun buildIR(module: Module, builder: IRBuilder) {
        ...
        // Create the function
        val function = builder.createFunction("ptr_to_int", functionType)
        ...
        // Create ptrtoint instruction
        val converted = builder.insertPtrToInt(arg0, IntegerType.I64, "converted")
        
        // Return the result
        builder.insertRet(converted)
    }
}
