...
/**
 * Extracted test case for SGE comparison predicate.
 * Originally from ComparisonPredicatesTest.testSGEPredicate()
 */
object SGETest {
    ...
    fun buildIR(module: Module, builder: IRBuilder) {
        ...
        val result = builder.insertICmp(IcmpPredicate.SGE, arg0, arg1, "result")
