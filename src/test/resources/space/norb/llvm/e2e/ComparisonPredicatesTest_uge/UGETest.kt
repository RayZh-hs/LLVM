...
/**
 * Extracted test case for UGE comparison predicate.
 * Originally from ComparisonPredicatesTest.testUGEPredicate()
 */
object UGETest {
    ...
    fun buildIR(module: Module, builder: IRBuilder) {
        ...
        val result = builder.insertICmp(IcmpPredicate.UGE, arg0, arg1, "result")
